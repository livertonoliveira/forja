...
FORJA_REPO="https://raw.githubusercontent.com/livertonoliveira/forja/main"
...
if [ ! -d "$COMMANDS_DIR" ]; then
  ...
  echo -e "  curl -sL https://raw.githubusercontent.com/livertonoliveira/forja/main/install.sh | bash"
  exit 1
fi
